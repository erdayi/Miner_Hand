...
CONFIG = {
    ...
    # 输出文件配置
    "output_file": "data/FreiHand/cluster_data/hdbscan/hand_clusters_hdbscan_min{min_cluster_size}_th{threshold}_merge{merge_threshold}.json",
    "unfiltered_output_file": "data/FreiHand/cluster_data/hdbscan/unfiltered_hdbscan_clusters.json"
}
...
def process_data(config):
    ...
    try:
        # 加载或计算距离矩阵
        distance_matrix_file, n_samples, error_matrix_calculation_time = load_or_calculate_distance_matrix(config)
