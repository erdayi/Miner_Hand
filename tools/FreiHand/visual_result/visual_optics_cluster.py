...
def main():
    ...
    # 聚类结果文件路径
    cluster_data_path = "../../../data/FreiHand/cluster_data/clusters_optics_32560_0.003_min8_xi0.1.json"

    # 拼接后图像的输出根目录
    output_root = "../../../data/FreiHand/visual_data/optics/003/minpts8_xi0.1"
