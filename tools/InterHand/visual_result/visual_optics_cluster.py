...
def main():
    ...
    # 聚类结果文件路径
    cluster_data_path = "data/InterHand/cluster_data/optics/hand_clusters_optics_left_min5_xi0.05_th0.0003_merge0.0003.json"
    
    # 拼接后图像的输出根目录
    output_root = "data/InterHand/visual_data/optics/left"
